...
from .forms import ProjectForm, MessageForm, SkillForm, SkillForm, EndorsementForm, CommentForm, QuestionForm
...
def homePage(request):
    ...
    detailedSkills = Skill.objects.exclude(body__isnull=True).exclude(body="")

    skills = Skill.objects.filter(body__isnull=True) | Skill.objects.filter(body="")
